...
foreach ($key in @("OZON_COOKIES", "OZON_COOKIES_FILE", "OZON_STORAGE_STATE_FILE", "OZON_EXTERNAL_SEARCH_URL", "OZON_EXTERNAL_SEARCH_HEADERS", "PARSER_HTTP_PROXY", "PARSER_USER_AGENT", "WILDBERRIES_COOKIES", "WILDBERRIES_COOKIES_FILE", "WILDBERRIES_STORAGE_STATE_FILE", "WILDBERRIES_DEST")) {
